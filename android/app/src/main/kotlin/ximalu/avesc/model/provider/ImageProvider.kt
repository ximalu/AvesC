package ximalu.avesc.model.provider
...
import ximalu.avesc.glide.AvesAppGlideModule
...
import ximalu.avesc.metadata.Metadata.TYPE_EXIF
import ximalu.avesc.metadata.Metadata.TYPE_IPTC
import ximalu.avesc.metadata.Metadata.TYPE_MP4
import ximalu.avesc.metadata.Metadata.TYPE_XMP
import ximalu.avesc.metadata.Mp4ParserHelper
import ximalu.avesc.metadata.Mp4ParserHelper.updateLocation
import ximalu.avesc.metadata.Mp4ParserHelper.updateRotation
import ximalu.avesc.metadata.Mp4ParserHelper.updateXmp
import ximalu.avesc.metadata.MultiPage
import ximalu.avesc.metadata.PixyMetaHelper
import ximalu.avesc.metadata.PixyMetaHelper.extendedXmpDocString
import ximalu.avesc.metadata.PixyMetaHelper.xmpDocString
import ximalu.avesc.metadata.metadataextractor.Helper
import ximalu.avesc.metadata.xmp.GoogleXMP
import ximalu.avesc.model.AvesEntry
import ximalu.avesc.model.EntryFields
import ximalu.avesc.model.ExifOrientationOp
import ximalu.avesc.model.FieldMap
import ximalu.avesc.model.NameConflictResolution
import ximalu.avesc.model.NameConflictStrategy
import ximalu.avesc.model.SourceEntry
import ximalu.avesc.utils.BitmapUtils
import ximalu.avesc.utils.BmpWriter
import ximalu.avesc.utils.FileUtils.transferFrom
import ximalu.avesc.utils.FileUtils.transferTo
import ximalu.avesc.utils.LogUtils
import ximalu.avesc.utils.MimeTypes
import ximalu.avesc.utils.MimeTypes.canEditExif
import ximalu.avesc.utils.MimeTypes.canEditIptc
import ximalu.avesc.utils.MimeTypes.canEditXmp
import ximalu.avesc.utils.MimeTypes.canReadWithExifInterface
import ximalu.avesc.utils.MimeTypes.canRemoveMetadata
import ximalu.avesc.utils.MimeTypes.extensionFor
