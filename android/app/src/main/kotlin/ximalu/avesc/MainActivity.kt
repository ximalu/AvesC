...
import ximalu.avesc.channel.calls.AccessibilityHandler
import ximalu.avesc.channel.calls.AnalysisHandler
import ximalu.avesc.channel.calls.AppAdapterHandler
import ximalu.avesc.channel.calls.AppProfileHandler
import ximalu.avesc.channel.calls.Coresult.Companion.safe
import ximalu.avesc.channel.calls.DebugHandler
import ximalu.avesc.channel.calls.DeviceHandler
import ximalu.avesc.channel.calls.EmbeddedDataHandler
import ximalu.avesc.channel.calls.GeocodingHandler
import ximalu.avesc.channel.calls.GlobalSearchHandler
import ximalu.avesc.channel.calls.HomeWidgetHandler
import ximalu.avesc.channel.calls.MediaEditHandler
import ximalu.avesc.channel.calls.MediaFetchObjectHandler
import ximalu.avesc.channel.calls.MediaSessionHandler
import ximalu.avesc.channel.calls.MediaStoreHandler
import ximalu.avesc.channel.calls.MetadataEditHandler
import ximalu.avesc.channel.calls.MetadataFetchHandler
import ximalu.avesc.channel.calls.SecurityHandler
import ximalu.avesc.channel.calls.StorageHandler
import ximalu.avesc.channel.calls.WallpaperHandler
import ximalu.avesc.channel.calls.window.ActivityWindowHandler
import ximalu.avesc.channel.calls.window.WindowHandler
import ximalu.avesc.channel.streams.darttoplatform.ActivityResultStreamHandler
import ximalu.avesc.channel.streams.darttoplatform.ImageByteStreamHandler
import ximalu.avesc.channel.streams.darttoplatform.ImageOpStreamHandler
import ximalu.avesc.channel.streams.darttoplatform.MediaStoreStreamHandler
import ximalu.avesc.channel.streams.platformtodart.AnalysisStreamHandler
import ximalu.avesc.channel.streams.platformtodart.ErrorStreamHandler
import ximalu.avesc.channel.streams.platformtodart.IntentStreamHandler
import ximalu.avesc.channel.streams.platformtodart.MediaCommandStreamHandler
import ximalu.avesc.channel.streams.platformtodart.MediaStoreChangeStreamHandler
import ximalu.avesc.channel.streams.platformtodart.SettingsChangeStreamHandler
import ximalu.avesc.channel.streams.platformtodart.WindowChangeStreamHandler
import ximalu.avesc.model.FieldMap
import ximalu.avesc.utils.LogUtils
import ximalu.avesc.utils.anyCauseIs
import ximalu.avesc.utils.getParcelableExtraCompat
...
//        )
    ...
    override fun onDestroy() {
        ...
        try {
            ...
            // `Fatal Exception:`
            // `java.lang.RuntimeException: Unable to destroy activity {ximalu.avesc/ximalu.avesc.MainActivity}:`
    ...
    companion object {
        ...
        const val INTENT_CHANNEL = "ximalu.avesc/intent"
