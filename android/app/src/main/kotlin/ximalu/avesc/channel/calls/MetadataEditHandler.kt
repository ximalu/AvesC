...
import ximalu.avesc.metadata.Mp4FragmentedException
import ximalu.avesc.metadata.Mp4TooLargeException
import ximalu.avesc.metadata.Mp4ZeroSizeBoxException
...
import ximalu.avesc.utils.FileDescriptorException
...
class MetadataEditHandler(private val contextWrapper: ContextWrapper) : MethodCallHandler {
    ...
    companion object {
        const val CHANNEL = "ximalu.avesc/metadata_edit"
    }
}
