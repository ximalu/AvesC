package ximalu.avesc.channel.streams.darttoplatform
...
import ximalu.avesc.decoding.RegionFetcher
import ximalu.avesc.decoding.SvgRegionFetcher
import ximalu.avesc.decoding.ThumbnailFetcher
import ximalu.avesc.decoding.TiffRegionFetcher
import ximalu.avesc.glide.AvesAppGlideModule
import ximalu.avesc.model.EntryFields
import ximalu.avesc.utils.BitmapUtils
import ximalu.avesc.utils.BitmapUtils.applyExifOrientation
import ximalu.avesc.utils.LogUtils
import ximalu.avesc.utils.MimeTypes
import ximalu.avesc.utils.MimeTypes.handleEncodedBytesInFlutter
import ximalu.avesc.utils.MimeTypes.isVideo
import ximalu.avesc.utils.MimeTypes.needRotationAfterGlide
...
class ImageByteStreamHandler(private val context: Context, private val arguments: Any?) : BaseStreamHandler(), ByteSink {
    ...
    companion object {
        ...
        const val CHANNEL = "ximalu.avesc/media_byte_stream"
    }
}
