...
import ximalu.avesc.metadata.xmp.GoogleDeviceContainer
import ximalu.avesc.metadata.xmp.GoogleXMP
import ximalu.avesc.metadata.xmp.XMP.getSafeStructField
import ximalu.avesc.metadata.xmp.XMPPropName
import ximalu.avesc.model.EntryFields
import ximalu.avesc.model.FieldMap
import ximalu.avesc.model.provider.ImageProvider
...
class EmbeddedDataHandler(private val context: Context) : MethodCallHandler {
    ...
    companion object {
        ...
        const val CHANNEL = "ximalu.avesc/embedded"
    }
}