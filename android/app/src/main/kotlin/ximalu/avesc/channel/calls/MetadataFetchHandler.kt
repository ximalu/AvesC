...
import ximalu.avesc.metadata.ExifGeoTiffTags
import ximalu.avesc.metadata.ExifInterfaceHelper
import ximalu.avesc.metadata.ExifInterfaceHelper.describeAll
import ximalu.avesc.metadata.ExifInterfaceHelper.getSafeDateMillis
import ximalu.avesc.metadata.ExifInterfaceHelper.getSafeDouble
import ximalu.avesc.metadata.ExifInterfaceHelper.getSafeInt
import ximalu.avesc.metadata.ExifInterfaceHelper.getSafeRational
import ximalu.avesc.metadata.ExifTags
import ximalu.avesc.metadata.GSpherical
import ximalu.avesc.metadata.GeoTiffKeys
import ximalu.avesc.metadata.MediaMetadataRetrieverHelper
import ximalu.avesc.metadata.MediaMetadataRetrieverHelper.getSafeDateMillis
import ximalu.avesc.metadata.MediaMetadataRetrieverHelper.getSafeDescription
import ximalu.avesc.metadata.MediaMetadataRetrieverHelper.getSafeDouble
import ximalu.avesc.metadata.MediaMetadataRetrieverHelper.getSafeInt
import ximalu.avesc.metadata.Metadata
import ximalu.avesc.metadata.Metadata.DIR_DNG
import ximalu.avesc.metadata.Metadata.DIR_EXIF_GEOTIFF
import ximalu.avesc.metadata.Metadata.DIR_PNG_TEXTUAL_DATA
import ximalu.avesc.metadata.Metadata.getRotationDegreesForExifCode
import ximalu.avesc.metadata.Metadata.isFlippedForExifCode
import ximalu.avesc.metadata.Mp4ParserHelper
import ximalu.avesc.metadata.MultiPage
import ximalu.avesc.metadata.PixyMetaHelper
import ximalu.avesc.metadata.QuickTimeMetadata
import ximalu.avesc.metadata.metadataextractor.Helper.PNG_ITXT_DIR_NAME
import ximalu.avesc.metadata.metadataextractor.Helper.PNG_LAST_MODIFICATION_TIME_FORMAT
import ximalu.avesc.metadata.metadataextractor.Helper.PNG_TIME_DIR_NAME
import ximalu.avesc.metadata.metadataextractor.Helper.containsGeoTiffTags
import ximalu.avesc.metadata.metadataextractor.Helper.extractGeoKeys
import ximalu.avesc.metadata.metadataextractor.Helper.extractPngProfile
import ximalu.avesc.metadata.metadataextractor.Helper.getDateDigitizedMillis
import ximalu.avesc.metadata.metadataextractor.Helper.getDateModifiedMillis
import ximalu.avesc.metadata.metadataextractor.Helper.getDateOriginalMillis
import ximalu.avesc.metadata.metadataextractor.Helper.getSafeBoolean
import ximalu.avesc.metadata.metadataextractor.Helper.getSafeDateMillis
import ximalu.avesc.metadata.metadataextractor.Helper.getSafeInt
import ximalu.avesc.metadata.metadataextractor.Helper.getSafeRational
import ximalu.avesc.metadata.metadataextractor.Helper.getSafeString
import ximalu.avesc.metadata.metadataextractor.Helper.isPngTextDir
import ximalu.avesc.metadata.metadataextractor.PngActlDirectory
import ximalu.avesc.metadata.metadataextractor.SafeXmpReader
import ximalu.avesc.metadata.metadataextractor.mpf.MpEntry
import ximalu.avesc.metadata.metadataextractor.mpf.MpEntryDirectory
import ximalu.avesc.metadata.xmp.GoogleXMP
import ximalu.avesc.metadata.xmp.XMP
import ximalu.avesc.metadata.xmp.XMP.doesPropExist
import ximalu.avesc.metadata.xmp.XMP.getPropArrayItemValues
import ximalu.avesc.metadata.xmp.XMP.getSafeDateMillis
import ximalu.avesc.metadata.xmp.XMP.getSafeInt
import ximalu.avesc.metadata.xmp.XMP.getSafeLocalizedText
import ximalu.avesc.metadata.xmp.XMP.hasHdrGainMap
import ximalu.avesc.metadata.xmp.XMP.isMotionPhoto
import ximalu.avesc.metadata.xmp.XMP.isPanorama
import ximalu.avesc.model.FieldMap
import ximalu.avesc.utils.ContextUtils.queryContentPropValue
import ximalu.avesc.utils.HashUtils
import ximalu.avesc.utils.LogUtils
import ximalu.avesc.utils.MimeTypes
import ximalu.avesc.utils.MimeTypes.TIFF_EXTENSION_PATTERN
import ximalu.avesc.utils.MimeTypes.canReadWithExifInterface
import ximalu.avesc.utils.MimeTypes.canReadWithMetadataExtractor
import ximalu.avesc.utils.MimeTypes.isIsoBMFFImage
import ximalu.avesc.utils.MimeTypes.isVideo
import ximalu.avesc.utils.StorageUtils
...
import ximalu.avesc.metadata.metadataextractor.Helper as MetadataExtractorHelper
...
class MetadataFetchHandler(private val context: Context) : MethodCallHandler {
    ...
    companion object {
        ...
        const val CHANNEL = "ximalu.avesc/metadata_fetch"
