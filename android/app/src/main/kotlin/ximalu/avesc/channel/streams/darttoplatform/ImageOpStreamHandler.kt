...
import ximalu.avesc.channel.calls.MediaEditHandler.Companion.cancelledOps
...
import ximalu.avesc.model.provider.MediaStoreImageProvider
...
class ImageOpStreamHandler(private val activity: Activity, private val arguments: Any?) : BaseStreamHandler() {
    ...
    companion object {
        ...
        const val CHANNEL = "ximalu.avesc/media_op_stream"
    }
}